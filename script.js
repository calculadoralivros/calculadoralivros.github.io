function calculate() {
    ...
    if (!isNaN(inputValue) && inputValue <= 100) {
        var result = 0.296 + (1.120 * inputValue) / 1000;
        ...
        document.getElementById("custo").style.fontWeight = "normal"; // Reset font-weight
    } else if (!isNaN(inputValue) && inputValue >= 101 && inputValue <= 250) {
        var result = 0.192 + (2.151 * inputValue) / 1000;
        document.getElementById("custo").innerText = "Custo: " + roundToDecimal(result, 2) + " €";
        document.getElementById("custoAzoresMadeira").innerText = "";
        document.getElementById("custo").style.fontWeight = "normal"; // Reset font-weight
    } else if (!isNaN(inputValue) && inputValue >= 251 && inputValue <= 500) {
        var result = 0.140 + (2.706 * inputValue) / 1000;
        document.getElementById("custo").innerText = "Custo: " + roundToDecimal(result, 2) + " €";
        document.getElementById("custoAzoresMadeira").innerText = "";
        document.getElementById("custo").style.fontWeight = "normal"; // Reset font-weight
    } else if (!isNaN(inputValue) && inputValue >= 501 && inputValue <= 2000) {
        var result = 1.519 + (0.625 * inputValue) / 1000;
        document.getElementById("custo").innerText = "Custo: " + roundToDecimal(result, 2) + " €";
        ...
        var result2000 = 1.519 + (0.625 * 2000) / 1000;
